...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingResponseDto approveBooking(Integer bookingId, Boolean approved, Integer ownerId) {
        ...
        if (!booking.getStatus().equals(BookingResponseStatus.WAITING)) {
        ...
        booking.setStatus(approved ? BookingResponseStatus.APPROVED : BookingResponseStatus.REJECTED);
        ...
        return bookings.stream()
                .filter(booking -> {
                    switch (state) {
                        ...
                        case WAITING:
                            return booking.getStatus() == BookingResponseStatus.WAITING;
                        case REJECTED:
                            return booking.getStatus() == BookingResponseStatus.REJECTED;
                        case ALL:
                        default:
                            return true;
                    }
